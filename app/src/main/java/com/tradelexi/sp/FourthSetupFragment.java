...
public class FourthSetupFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FragmentNavigator.Extras extras2 = new FragmentNavigator.Extras.Builder()
                ...
                .build();
        binding.buttonBack.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_fourthSetupFragment_to_thirdSetupFragment, null, null, extras1));
        binding.buttonNext.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_fourthSetupFragment_to_fifthSetupFragment, null, null, extras2));
    }
